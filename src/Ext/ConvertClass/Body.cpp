...
{
	auto* const pPaletteData = static_cast<BYTE*>(this->PaletteData);
	auto* const pRemapData = static_cast<BYTE*>(this->ByteColorData);
...
{
	auto* const pPaletteData = static_cast<WORD*>(this->PaletteData);
	auto* const pFullColorData = static_cast<WORD*>(this->FullColorData);
	auto const ppCurrentZRemap = reinterpret_cast<BYTE**>(&this->CurrentZRemap);
	const WORD halfTranslucencyMask = static_cast<WORD>(this->HalfTranslucencyMask);
	const WORD quatTranslucencyMask = static_cast<WORD>(this->QuatTranslucencyMask);
