...
DEFINE_BLITTER(BlitTransLucent75AlphaZRead, BlitterPixelWordOnly)
{
public:
	inline explicit BlitTransLucent75AlphaZRead(WORD* data, WORD mask, int shadecount) noexcept
	{
