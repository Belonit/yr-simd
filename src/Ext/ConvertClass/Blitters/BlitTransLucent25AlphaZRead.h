...
DEFINE_BLITTER(BlitTransLucent25AlphaZRead, BlitterPixelWordOnly)
{
public:
	inline explicit BlitTransLucent25AlphaZRead(WORD* data, WORD mask, int shadecount) noexcept
	{
