...
DEFINE_RLE_BLITTER(RLEBlitTransLucent75AlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent75AlphaZReadWrite(WORD* data, WORD mask, int shadecount) noexcept
	{
