...
DEFINE_RLE_BLITTER(RLEBlitTransLucent25Alpha, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent25Alpha(WORD* data, WORD mask, int shadecount) noexcept
	{
