...
DEFINE_RLE_BLITTER(RLEBlitTransLucent25AlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent25AlphaZReadWrite(WORD* data, WORD mask, int shadecount) noexcept
	{
