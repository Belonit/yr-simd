...
DEFINE_RLE_BLITTER(RLEBlitTransLucent50AlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent50AlphaZReadWrite(WORD* data, WORD mask, int shadecount) noexcept
	{
