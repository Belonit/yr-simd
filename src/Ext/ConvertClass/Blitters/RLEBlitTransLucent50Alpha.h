...
DEFINE_RLE_BLITTER(RLEBlitTransLucent50Alpha, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent50Alpha(WORD* data, WORD mask, int shadecount) noexcept
	{
