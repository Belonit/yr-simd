...
DEFINE_BLITTER(BlitTransLucent75AlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit BlitTransLucent75AlphaZReadWrite(WORD* data, WORD mask, int shadecount) noexcept
	{
