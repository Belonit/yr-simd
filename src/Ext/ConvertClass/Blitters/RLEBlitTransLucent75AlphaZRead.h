...
DEFINE_RLE_BLITTER_INHERITABLE(RLEBlitTransLucent75AlphaZRead, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransLucent75AlphaZRead(WORD* data, WORD mask, int shadecount) noexcept
	{
	...
	virtual ~RLEBlitTransLucent75AlphaZRead() override = default;
