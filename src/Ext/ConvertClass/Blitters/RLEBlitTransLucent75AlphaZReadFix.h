				...
				if (srcv)
				{
					...
					while (remaining >= ChunkSize)
					{
						...
						if (zMask)
						{
							...
							const __m512i result32 = _mm512_sub_epi32(_mm512_or_si512(blended32, destColors), _mm512_srli_epi32(_mm512_and_si512(_mm512_xor_si512(blended32, destColors), f7de32), 1));
					...
					if (srcv)
					{
						...
						while (remaining >= ChunkSize)
						{
							...
							if (_mm_movemask_epi8(zMask16))
							{
								...
								const __m128i result16 = _mm_sub_epi16(_mm_or_si128(blended16, dest16), _mm_srli_epi16(_mm_and_si128(_mm_xor_si128(blended16, dest16), f7de16), 1));
