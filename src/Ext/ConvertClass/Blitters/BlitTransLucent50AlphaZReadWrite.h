...
DEFINE_BLITTER(BlitTransLucent50AlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit BlitTransLucent50AlphaZReadWrite(WORD* data, WORD mask, int shadecount) noexcept
	{
