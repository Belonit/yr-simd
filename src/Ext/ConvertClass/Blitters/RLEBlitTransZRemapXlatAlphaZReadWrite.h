...
DEFINE_RLE_BLITTER(RLEBlitTransZRemapXlatAlphaZReadWrite, BlitterPixelWordOnly)
{
public:
	inline explicit RLEBlitTransZRemapXlatAlphaZReadWrite(byte** remapData, WORD* data, int shadecount) noexcept
	{
					...
					if (srcv)
					{
						...
						while (remaining >= ChunkSize)
						{
							...
							if (_mm_movemask_epi8(zMask16))
							{
								...
								const __m128i zBlended16 = Sse2_BlendU16(oldZ16, zValues16, zMask16);
