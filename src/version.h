...
// Indicates yr-simd-related bugfixes only
#define VERSION_PATCH 0

#define PRODUCT_NAME "yr-simd"
#define FILE_DESCRIPTION "yr-simd"

// Nightly defines GIT_COMMIT and GIT_BRANCH in GH Actions

#ifdef IS_RELEASE_VER // Release build metadata
	#ifdef GIT_TAG
		#define STR_GIT_TAG _STR(GIT_TAG)
		#define FILE_VERSION_STR STR_GIT_TAG
	#else
